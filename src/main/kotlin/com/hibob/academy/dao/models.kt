...
data class PetData( val petId: Long, val ownerId: Long?, val name: String, val type: PetType, val companyId: Long, val dateOfArrival: LocalDate)

data class PetDataInsert(val ownerId: Long?, val name: String, val type: PetType, val companyId: Long)

data class OwnerData(val ownerId: Long, val name: String, val companyId: Long, val employeeId: String)
